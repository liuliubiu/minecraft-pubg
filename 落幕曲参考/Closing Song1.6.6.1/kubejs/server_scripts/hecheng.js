    ...
    event.shaped('celestial_artifacts:catastrophe_scroll',[
        ...
        ['iceandfire:dragonbone','iceandfire:dragonbone','iceandfire:dragonbone'],
            ...
            event.shaped('zenith:zenith',[
                ['iceandfire:silver_sword','iceandfire:copper_sword','iceandfire:dragonbone_sword'],
                ['celestial_core:virtual_gold_sword','minecraft:netherite_sword','soulsweapons:guts_sword'],
                ['soulsweapons:moonveil','celestial_core:guardian_ocean_sword','dodosmobs:amalgam_claws'],
            ])
            ...
            event.shaped('bosses_of_mass_destruction:soul_star',[
                ...
                ['soulsweapons:lost_soul','minecraft:gold_ingot','soulsweapons:lost_soul'],
                [,'soulsweapons:lost_soul']
            ])
            ...
            event.shaped('touhou_little_maid_spell:hairpin',[
                ...
                ['celestial_core:sakura_steel','celestial_core:pure_nether_star','celestial_core:sakura_steel'],
                ['celestial_core:sakura_steel','celestial_core:sakura_steel','minecraft:totem_of_undying']
            ])

            event.shaped('alexsmobs:spawn_egg_leafcutter_ant',[
                ['minecraft:oak_leaves','minecraft:oak_leaves','minecraft:oak_leaves'],
                ['minecraft:oak_leaves','alexsmobs:maggot']
            ])

            event.shaped('summoningrituals:altar',[
                ['minecraft:gold_ingot','minecraft:red_wool','minecraft:gold_ingot'],
                [,'#minecraft:planks'],
                ['#minecraft:planks','minecraft:gold_block','#minecraft:planks']
    ])


            event.shaped('alexsmobs:spawn_egg_cachalot_whale',[
                ['minecraft:salmon','minecraft:salmon','minecraft:salmon'],
                ['minecraft:salmon','minecraft:enchanted_golden_apple','minecraft:salmon'],
                ['minecraft:salmon','minecraft:salmon','minecraft:salmon']
            ])

            event.shaped('goety:fell_blade',[
                [,'goety:ectoplasm','goety:cursed_metal_block'],
                ['goety:dark_fabric','goety:cursed_metal_block','goety:ectoplasm'],
                ['minecraft:oak_log','goety:magic_fabric']
            ])

            event.shaped('2x ironfurnaces:million_furnace',[
                ['ironfurnaces:million_furnace','dreadsteel:dreadsteel_ingot']
            ])

            event.shaped('2x alexscaves:darkened_apple',[
                ['alexscaves:pure_darkness','minecraft:apple'],
                ['minecraft:apple']
            ])

            event.shaped('cataclysm:music_disc_the_cataclysmfarer',[
                ['cataclysm:music_disc_netherite_monstrosity','cataclysm:music_disc_ender_guardian','cataclysm:music_disc_ignis'],
                ['cataclysm:music_disc_the_harbinger','dreadsteel:dreadsteel_ingot','cataclysm:music_disc_the_leviathan'],
                ['cataclysm:music_disc_ancient_remnant','cataclysm:music_disc_maledictus','cataclysm:music_disc_scylla']
            ])

 event.shaped("goety:dark_anvil", [
    ["minecraft:iron_block", "goety:dark_metal_block", "minecraft:iron_block"],
    [, "minecraft:iron_ingot"],
    ["minecraft:iron_ingot", "minecraft:iron_ingot", "minecraft:iron_ingot"],
  ]);

  if (checkExists("refinedstorage:creative_storage_disk")) {
...
function checkExists(itemId) {
  // 物品不存在的话，ItemStack会返回minecraft:air
  return Item.of(itemId).id == itemId;
}
