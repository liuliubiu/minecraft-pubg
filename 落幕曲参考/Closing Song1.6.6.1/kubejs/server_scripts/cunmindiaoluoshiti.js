LootJS.modifiers((event) => {
    event
        ...
        event
        .addEntityLootModifier("dodosmobs:bone_chimera")    
        .addLoot('4x minecraft:diamond','16x minecraft:emerald','soulsweapons:moonstone')  

        event
        .addEntityLootModifier("minecraft:pig")    
        .randomChance(0.1) // 30% 概率
        .addLoot('smithstory:ranjinle');

        event
        .addEntityLootModifier("minecraft:warden")    
        .randomChance(0.1) // 30% 概率
        .addLoot('smithstory:naiyin');
    });               